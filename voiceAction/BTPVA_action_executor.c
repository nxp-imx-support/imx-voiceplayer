...
static void BTPVA_call_custom(int WW, int cmd) {
  ...
  case 1: /* MUTE */
    if (iConnectionToBT != true) {
      ...
      printf("MUTE command\n");
      strcpy(sVolume, "/opt/gopoint-apps/scripts/multimedia/imx-voiceplayer/volume.sh ");
  ...
  case 8: /* STOP PLAYER */
    ...
    system("/opt/gopoint-apps/scripts/multimedia/imx-voiceplayer/stop.sh");
    break;
  case 9: /* START PLAYER */
    popen("/opt/gopoint-apps/scripts/multimedia/imx-voiceplayer/VoicePlayer -platform wayland &", R_MODE);
    break;
  case 10: /* VOLUME UP */
    if (iConnectionToBT != true) {
      printf(NO_CONNECTION_TO_BT);
